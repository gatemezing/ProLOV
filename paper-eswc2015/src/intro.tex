...
\begin{itemize}
	...
	\vspace{-1mm}\item Select the most appropriate term taking into the account its score.
	\vspace{-1mm}\item Include the selected term in the ontology that has being developed. There are three alternatives in this case: 
	\begin{itemize}
